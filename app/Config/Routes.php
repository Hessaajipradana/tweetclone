...
$routes->get('/profileHome', 'Auth::profileHome');


$routes->get('/editProfile', 'Auth::profile');
$routes->match(['get', 'post'], '/editProfile', 'Auth::profile');

$routes->add('/resetPassword', 'Auth::resetPassword');
